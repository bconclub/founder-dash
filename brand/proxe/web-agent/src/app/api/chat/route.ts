...
import { addUserInput, upsertSummary, checkExistingBooking, fetchSummary, logMessage, ensureAllLeads, updateSessionProfile } from '@/lib/chatSessions';
import { proxeConfig } from '@/configs/proxe.config';
...
const proxeSupabase = getSupabaseClient();
